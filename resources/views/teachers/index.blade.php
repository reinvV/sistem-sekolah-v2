...
<div class="mb-8 flex items-end justify-between border-b border-[#E5E3DB] pb-5">
    <div>
        <p class="mb-1 text-[11px] uppercase tracking-[0.2em] text-[#A16207]">Tenaga Pendidik</p>
    ...
    <table class="w-full text-left text-sm">
        ...
        @foreach ($teachers as $teacher)
            <tr class="border-b border-[#EFEDE6] hover:bg-[#FAF9F5]">
                ...
                <td class="px-5 py-4">
                    <span class="inline-block rounded-full bg-emerald-50 px-2.5 py-1 text-[11px] font-semibold text-emerald-700">
                        {{ $teacher['status'] }}
                    </span>
                </td>
